...
def create_procs(
    mp_ctx, dataset_q, stop_q, plugin, logger_q, log_level, duration, concurrency
):
...
def main(args):
    ...
    try:
        ...
        for n_users in concurrency:
            ...
            procs, results_pipes = create_procs(
                mp_ctx,
                dataset_q,
                stop_q,
                plugin,
            ...
            utils.write_output(
                config, results_list, concurrency=n_users, duration=duration
            )
